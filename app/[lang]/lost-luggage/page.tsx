...
// the bag, not whoever lost it. Kept as a permanent (308) redirect so tags
// already printed with the old URL (and the old QR code) keep working.
...
export default async function LostLuggageRedirectPage({ params }: PageProps) {
  ...
  permanentRedirect(`/${locale}/found-luggage` as Route);
}
